...
CREATE TABLE `customer` (
  ...
  CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `employee` (`num`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `customer` */

insert  into `customer`(`id`,`name`,`contactLastName`,`contactFirstName`,`phone`,`address`,`addressLine2`,`city`,`state`,`postalCode`,`country`,`salesRepEmployeeNumber`,`creditLimit`) values
...
CREATE TABLE `employee` (
  ...
  CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`reportsTo`) REFERENCES `employee` (`num`),
  CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`officeCode`) REFERENCES `offices` (`officeCode`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `employee` */

insert  into `employee`(`num`,`lastName`,`firstName`,`extension`,`email`,`officeCode`,`reportsTo`,`jobTitle`) values
...
insert  into `offices`(`officeCode`,`city`,`phone`,`address`,`addressLine2`,`state`,`country`,`postalCode`,`territory`) values
...
CREATE TABLE `order` (
  ...
  KEY `product` (`product`),
  CONSTRAINT `orderdetails_ibfk_1` FOREIGN KEY (`orderNumber`) REFERENCES `detail` (`orderNumber`),
  CONSTRAINT `orderdetails_ibfk_2` FOREIGN KEY (`product`) REFERENCES `product` (`product`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `order` */

insert  into `order`(`orderNumber`,`product`,`quantity`,`price`,`orderLineNumber`) values
...
CREATE TABLE `detail` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`id`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `detail` */

insert  into `detail`(`orderNumber`,`orderDate`,`requiredDate`,`shippedDate`,`status`,`comments`,`id`) values
...
CREATE TABLE `payments` (
  ...
  CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`id`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert  into `product`(`product`,`productName`,`productLine`,`productScale`,`productVendor`,`productDescription`,`quantityInStock`,`buyPrice`,`MSRP`) values
