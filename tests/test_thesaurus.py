...
DATABASE_PATH = './eng2sql/database/'
LANG_PATH = './eng2sql/lang/'
THESAURUS_PATH = './eng2sql/thesaurus/'
...
def frenchThesaurusUsing():
    ...
    for test in frenchThesaurusUsing:
        assert _clean_output(Eng2sql(test['database'], test['language'], thesaurus_path=test['thesaurus']).get_query(test['input'])) == test['output']
